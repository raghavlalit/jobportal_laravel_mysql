@extends ('layouts.main')
    ...
    <div class="hero-wrap" style="background-image: url('images/bg_2.jpg');" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
        ...
        <div class="row no-gutters slider-text align-items-end justify-content-start" data-scrollax-parent="true" style="padding-top: 120px;">
          <div class="col-md-8 ftco-animate text-md-left mb-5" data-scrollax=" properties: { translateY: '70%' }">
